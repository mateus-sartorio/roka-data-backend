class ResidentsController < ApplicationController
  ...
  private
    ...
    def resident_params
      params.require(:resident).permit(:id, :name, :description, :situation, :roka_id, :has_plaque, :registration_year, :registration_date,:address, :reference_point, :lives_in_jn, :phone, :is_on_whatsapp_group, :birthdate, :profession, :residents_in_the_house, :observations, :needs_collect_on_the_house, :shift_for_collection_on_the_house)
    end
end
